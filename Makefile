...
PKG_SOURCES	=  tclmonetdbe.c monetdbeStubInit.c
PKG_OBJECTS	=  tclmonetdbe.o monetdbeStubInit.o
...
PKG_TCL_SOURCES =  library/tdbcmonetdbe.tcl
...
PKG_LIB_FILE	= libmonetdbe0.2.1.so
PKG_LIB_FILE8	= libmonetdbe0.2.1.so
PKG_LIB_FILE9	= libtcl9monetdbe0.2.1.so
PKG_STUB_LIB_FILE = libmonetdbestub0.2.1.a
...
top_builddir	= /home/danilo/Public/tcl-monetdbe
